...
class UserPermission(PermissionMixin):
    ...
    def patch_data(self, *args, data: dict = None, obj: UserModel = None, user_permission: PermissionUser = None, **kwargs) -> dict:
        permission_for_patch = user_permission.permission_for_patch_permission(model=UserModel)
        return {
            i_key: i_val
